...
public class BocXmlUtil {
    ...
    public static void validateViaDOM(String s, Schema schema) throws Exception {
        DOMSource domsource = new DOMSource(createDocument(s));
        Validator validator = schema.newValidator();
        validator.validate(domsource);
    }

    public static void validateViaSAX(String s, Schema schema) throws Exception {
    ...
    public static Document createDocument(String s) throws Exception {
        DocumentBuilder documentbuilder = createDocumentBuilder();
        return documentbuilder.parse(new ByteArrayInputStream(s
                .getBytes("UTF-8")));
    }

    public static Document createDocument(String s, String s1) throws Exception {
        DocumentBuilder documentbuilder = createDocumentBuilder();
    ...
    public static String getNodeAttributeValue(Document document, String s,
    ...
    public static String getNodeText(Node node, String s) throws Exception {
        NodeList nodelist = node.getChildNodes();
        int i = nodelist.getLength();
        for (int j = 0; j < i; j++) {
            Node node1 = nodelist.item(j);
