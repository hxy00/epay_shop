...
public class BocPKCSTool {
	 ...
	 * @throws IOException
	 */
	public static BocPKCSTool getSigner(String keyStorePath,
		...
		BocPKCSTool tool = new BocPKCSTool(SIGNER);
	 ...
	 * @throws IOException
	 */
	public static BocPKCSTool getVerifier(InputStream rootCertStream,
		...
		BocPKCSTool tool = new BocPKCSTool(VERIFIER);
		if (rootCertStream != null) {
